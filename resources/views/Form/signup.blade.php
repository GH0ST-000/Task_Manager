        ...
        <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div class="max-w-md w-full space-y-8">
                ...
                <div class="rounded bg-white max-w-md rounded overflow-hidden shadow-xl p-5">
                    ...
                    <form class="space-y-4 border-b-2 border-gray-800" action="/custom-registration" method="POST">
                        @csrf
                        ...
                        <div class="rounded-md shadow-sm -space-y-px">
                            <div class="grid gap-6">
                                ...
                                <div class="col-span-12">
                                    <label for="text" class="block text-sm font-medium text-gray-700">Enter Full Name</label>
                                    <input type="text" name="name" id="name"
                                           class="border h-8 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    @if ($errors->has('name'))
                                        <span class="bg-gray-800 text-red-600 font-medium text-sm rounded-md">{{ $errors->first('name') }}</span>
                                    @endif
                                </div>
                                <div class="col-span-12">
